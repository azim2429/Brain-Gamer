...
$(function() {
  ...
  $('#container').highcharts({
    ...
    xAxis: {
      categories: ['Week-1', 'Week-2', 'Week-3', 'Week-4', 'Week-5', 'Week-6', 'Week-7', 'Week-8', 'Week-10', 'Week-11', 'Week-12', 'Week-13'],
    },
    yAxis:{
      title: {
            enabled: true,
    ...
    series: [{
      name: 'Average Score',
      data: [100,200,120,100,40,70,100],
